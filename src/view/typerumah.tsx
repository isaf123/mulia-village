...
const TypeRumah: React.FunctionComponent<ITypeRumahProps> = (props) => {
  ...
  return (
    <div className="h-fit mb-[70px]">
      <div className="mt-[40px] mb-[80px] md:mb-[136px]">
        <Divider2>Type Rumah</Divider2>
      </div>
      <h3 className="text-center text-[16px] md:text-[24px] m-auto text-color1 w-[390px] md:w-[1510px] px-6 md:px-0">
      ...
      <div className="flex  flex-wrap w-[390px] md:w-[1900px] h-fit gap-10 md:gap-10 justify-center mt-[70px]">
        {mapping()}
      </div>
    </div>
  );
